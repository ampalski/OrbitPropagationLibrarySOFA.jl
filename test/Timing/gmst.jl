@testset "GMST Vallado" begin
    ...
    @test isapprox(gmst(JD; model = 82), 5.459562588350443; atol = 1.0e-8)
    @test isapprox(gast(JD; model = 94), 5.459507978743478; atol = 1.0e-8)
...
@testset "GMST SOFA" begin
    ...
    @test isapprox(gmst(j; model = 82), 1.754174981860675096; atol = 1.0e-12)
    @test isapprox(gast(j; model = 94), 1.754166136020645203; atol = 1.0e-9)
